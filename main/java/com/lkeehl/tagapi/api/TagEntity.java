...
public interface TagEntity {
     ...
     **/
    TagEntity injectPacket(Function<TagEntity, PacketContainer> packetContainer);

    /**
     * Allows the ability to add additional metadata properties to the tag's metadata packet.
     **/
    TagEntity injectMetaData(BiConsumer<TagEntity, WrappedDataWatcher> metaDataConsumer);
